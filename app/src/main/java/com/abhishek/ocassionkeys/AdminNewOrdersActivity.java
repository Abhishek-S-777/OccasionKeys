...
import com.abhishek.ocassionkeys.Model.AdminOrders;
...
public class AdminNewOrdersActivity extends AppCompatActivity
{
    ...
    public void onSend(){
        ...
        String usrname= Prevalant.currentOnlineUsers.getName();
        ...
        if(checkPermission(Manifest.permission.SEND_SMS)){
            ...
            smsManager.sendTextMessage(phoneNumber, null, "Dear " + usrname + " Your order has been verified by Admin and will be shipped to your address soon!", null, null);
