...
public class ProductDetailsActivity extends AppCompatActivity
{
    ...
    private void addingToCartList()
    {
        ...
        cartListRef.child("User View").child(Prevalant.currentOnlineUsers.getPhone())
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            cartListRef.child("Admin View").child(Prevalant.currentOnlineUsers.getPhone())
                                    .child("Products").child(productID)
                                    .updateChildren(cartMap)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
    ...
    private void CheckOrderState()
    {
        ...
        ordersRef = FirebaseDatabase.getInstance().getReference().child("Orders").child(Prevalant.currentOnlineUsers.getPhone());
