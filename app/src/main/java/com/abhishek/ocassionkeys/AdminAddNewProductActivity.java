...
public class AdminAddNewProductActivity extends AppCompatActivity
{
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        itemsMap.put("pid", productRandomKey);
        itemsMap.put("date", saveCurrentDate);
        itemsMap.put("time", saveCurrentTime);
        itemsMap.put("description", Description);
        itemsMap.put("image", downloadImageUrl);
        itemsMap.put("category", CategoryName);
        itemsMap.put("price", Price);
        itemsMap.put("pname", Pname);

        ProductsRef.child(productRandomKey).updateChildren(itemsMap)
