...
public class UPIpayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //String totamtt=bundle.getString("pricess");*/

        totalAmount1 = getIntent().getStringExtra("Total Pricee");


        send = (Button) findViewById(R.id.send);
        amount = (TextView) findViewById(R.id.amttxt);
        note = (EditText)findViewById(R.id.note);
        name = (EditText) findViewById(R.id.name);
        upivirtualid =(EditText) findViewById(R.id.upi_id);

        amount.setText(String.valueOf(totalAmount1));
